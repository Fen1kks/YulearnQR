const translations = {
  tr: {
    ...
    vibrationTitle: 'Titreşim (Haptic)',
    vibrationDesc: 'Tarama işlemi başarılı olduğunda titreşim ile uyarır.',
    autoRedirectTitle: 'Anında Yönlendir',
    autoRedirectDesc: 'Onay beklemeden doğrudan derse katılım sayfasına yönlendirir.',
  ...
  en: {
    ...
    vibrationTitle: 'Vibration (Haptic)',
    vibrationDesc: 'Vibrates the device when an item scans successfully.',
    autoRedirectTitle: 'Auto-Redirect',
    autoRedirectDesc: 'Redirects to the attendance page directly without waiting for validation overlay.',
